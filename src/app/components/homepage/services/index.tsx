...
export default function Services() {
    return (
        <div className={`${style.services} bg-white`}>
            <div className={`m-auto flex p-12 pb-6 pl-0 max-[640px]:flex-col max-[640px]:text-center max-[640px]:px-4`}>
                <div className='w-1/2 max-[640px]:w-full'>
                    <img src="/images/circles.png" alt="" />
                </div>
                <div className='w-1/2 max-[640px]:w-full py-12 px-4'>
                    <h4 className='font-bold text-xl pb-2 link1'>Our services</h4>
                    <p className='uppercase text-4xl pb-8'>
                        <span style={{color:'rgb(var(--foreground-rgb))'}} className={style.light}>Features that </span>
                        <span style={{color:'rgb(var(--foreground-rgb))'}} className='font-bold '>differentiate us from others!</span>
                    </p>
                    <div className='flex flex-wrap max-[640px]:flex-col'>
                        <div className='w-1/2 pr-8 pb-6 max-[640px]:w-full max-[640px]:text-center max-[640px]:py-4'>
